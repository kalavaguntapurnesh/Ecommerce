        ...
        <div className="flex flex-col items-center justify-center px-6 mx-auto">
          <div className="w-full bg-white  dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-4 sm:p-8">
              <h1 className="text-xl text-center font-medium md:text-2xl dark:text-white">
                Login with email / phoneNumber
              </h1>
              <form
              ...
              >
                ...
                <button
                  // href="/dashboard"
                  type="submit"
                  className="w-full text-white bg-black hover:bg-colorFour transition ease-in-out duration-1000 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center cursor-pointer"
                >
                  Login
                </button>
